...
This repository holds the Ruby on Rails pair programming challenges for the 2023 Bravo cohort.
...
(ex. rails-intro-ts-ww)
- File name: `topic-name1-name2.md`  
(ex. rails-intro-trish-will.md)
...
(ex. git checkout -b rails-intro-ts-ww)
